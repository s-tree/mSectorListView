...
public class MyRoundView extends FrameLayout implements MySectorView.TouchListener{
    public static final int LEFT = 1;
    public static final int RIGHT = 2;

    private MySectorView centerView,outSideView;
    private MyRoundListView myRoundListView;
    ...
    private void init(AttributeSet attrs){
        centerView = new MySectorView(getContext());
        outSideView = new MySectorView(getContext());
        myRoundListView = new MyRoundListView(getContext());
