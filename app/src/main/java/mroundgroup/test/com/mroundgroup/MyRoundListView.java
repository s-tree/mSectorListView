...
public class MyRoundListView extends ViewGroup {
    ...
    public MyRoundListView(Context context){
        this(context, null);
    }

    public MyRoundListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public MyRoundListView(Context context, AttributeSet attrs, int defStyleAttr) {
